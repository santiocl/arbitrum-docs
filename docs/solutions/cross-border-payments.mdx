...
The diagram below shows how **institutional treasury and payment teams** typically wire partners for cross-border settlement on Arbitrum One. It is not a map of every fintech path; it highlights the stack most enterprise buyers use: compliance and orchestration offchain, stablecoin settlement on Arbitrum One, and fiat conversion through regulated partners.
...
**How to read this flow (institutional):**
...
Not every box is required for a pilot. Most institutions start with **custody + native USDC on Arbitrum One + one ramp partner**, then add contracts or dedicated-chain options when policy demands it.
...
The diagram below is the **institutional dedicated-chain** view: your L2 still **anchors to Ethereum** for security, while you control sequencing policy, fee denomination, and what executes on your ledger. **Fiat stays offchain** (banks, ramps, custody); your chain settles **stablecoins and smart-contract logic** — the same separation as Arbitrum One, but on infrastructure you operate or permission.
...
<table className="solutions-payments-table">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>Legacy bridged USDC from Ethereum; prefer native USDC for new institutional flows</td>
