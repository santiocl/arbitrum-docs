...
<table className="solutions-payments-table">
  ...
  <tbody>
    <tr>
      ...
      <td>Circle-issued on Arbitrum One; default for most pilots, CEX support, and direct redemption</td>
    </tr>
    <tr>
      <td><strong>Bridged USDC (USDC.e)</strong></td>
      <td>Ethereum-native USDC via Arbitrum's canonical bridge; legacy liquidity — prefer native USDC for new flows</td>
    </tr>
    <tr>
      <td><strong>USDT</strong></td>
      <td>Strong adoption in LATAM, Africa, and parts of APAC</td>
    </tr>
    <tr>
      <td><strong>PYUSD</strong></td>
      <td>PayPal USD on Arbitrum One (<a href="https://docs.paxos.com/guides/developer/blockchains">Paxos</a>); PayPal ecosystem payouts</td>
    </tr>
    <tr>
      <td><strong>USDL</strong></td>
      <td>Yield-bearing USD stablecoin on Arbitrum One (<a href="https://www.paxos.com/newsroom/yield-bearing-stablecoin-lift-dollar-usdl-launches-on-arbitrum">Paxos International</a>); treasury yield use cases</td>
    </tr>
  </tbody>
</table>
...
<table className="solutions-payments-table">
  ...
  <tbody>
    <tr>
      ...
      <td>Euro stablecoin native on Arbitrum One (<a href="https://dev.euroe.com/docs/Stablecoin/contract-addresses">Membrane Finance</a>, <a href="https://arbiscan.io/token/0xcf985aba4647a432e60efceeb8054bbd64244305">Arbiscan</a>); EU-regulated, suited to SEPA-corridor payouts</td>
    </tr>
    <tr>
      <td><strong>EURS</strong></td>
      <td>STASIS euro stablecoin on Arbitrum One (<a href="https://arbiscan.io/token/0xd22a58f79e9481d1a88e00c343885a588b34b68b">Arbiscan</a>); established DeFi liquidity (for example Aave v3)</td>
    </tr>
    <tr>
      <td><strong>EURC</strong></td>
      <td>Circle euro stablecoin; <strong>not natively issued on Arbitrum</strong> per <a href="https://developers.circle.com/circle-mint/references/supported-chains-and-currencies">Circle supported chains</a> — any EURC on Arbitrum is bridged; confirm issuer and redemption path before use</td>
    </tr>
  </tbody>
</table>
...
<table className="solutions-payments-table">
  ...
  <tbody>
    <tr>
      <td>Circle (USDC)</td>
      <td>Native and bridged USDC on Arbitrum One</td>
      <td><a href="/for-devs/third-party-docs/Circle/usdc-quickstart-guide">USDC quick start</a> · <a href="/arbitrum-bridge/usdc-arbitrum-one">USDC on Arbitrum One</a></td>
    </tr>
    <tr>
      <td>Tether (USDT)</td>
      <td>USDT liquidity on Arbitrum One</td>
      <td><a href="https://tether.to/en/developers">Tether documentation</a> <em>(external)</em></td>
    </tr>
    <tr>
      <td>Paxos (PYUSD, USDL)</td>
      <td>PYUSD and USDL on Arbitrum One</td>
      <td><a href="https://docs.paxos.com/guides/developer/blockchains">Paxos blockchains</a> <em>(external)</em></td>
    </tr>
    <tr>
      <td>PayPal (PYUSD)</td>
      <td>PayPal USD stablecoin</td>
      <td><a href="https://developer.paypal.com/">PayPal Developer</a> <em>(external)</em></td>
    </tr>
    <tr>
      <td>Membrane Finance (EUROe)</td>
      <td>Euro stablecoin native on Arbitrum One</td>
      <td><a href="https://dev.euroe.com/docs/Stablecoin/contract-addresses">EUROe contract addresses</a> <em>(external)</em></td>
    </tr>
    <tr>
      <td>STASIS (EURS)</td>
      <td>Euro stablecoin on Arbitrum One</td>
